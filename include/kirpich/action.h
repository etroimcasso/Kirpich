...
//
// These are the piece-control actions. The gameplay input handler (RotateAndShiftPiece,
// tetris.asm:5910-6028) and the soft-drop path bind A to rotate clockwise, B to rotate
// counter-clockwise, LEFT/RIGHT to shift the piece, and DOWN to soft drop. The enum gains enumerators
// as more input surfaces (menus, start/select) land.
